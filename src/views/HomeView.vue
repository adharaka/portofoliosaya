<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Adha Raka Firmansyah</h1>
      <div class="py-2">
        <h1
      ...
      <a href="https://drive.google.com/file/d/16Pe22L2ZMXj8S-uowugp2JXR_o_ovbFZ/view?usp=sharing" target="_blank"
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300"
        ...
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="/img/avatar.jpg">
    </div>
  </main>
</template>
